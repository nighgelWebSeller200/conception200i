document.addEventListener("DOMContentLoaded", () => {
    ...
    function hideAllSections() {
      ...
      buttons.forEach((button) => {
        button.style.backgroundColor = "#ADD8E6"; // Reset to light blue
    ...
    function styleButton(button) {
      button.style.backgroundColor = "#ADD8E6"; // Light blue background
    ...
    function createButton(button, label, section) {
      ...
      button.addEventListener("click", () => {
        ...
        button.style.backgroundColor = "#d1e7e1"; // White background when active
        button.style.color = "#808080"; // Black font when active
        button.style.justifyContent = 'center';
      });
